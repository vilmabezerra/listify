...
public class Error {
	public static final String NO_FILE_ERROR = "Error: No File Argument";
	public static final String MORE_THAN_ONE_ERROR = "Error: More than one File Argument";
	public static final String FILE_EXTENSION_ERROR = "Error: File given as argument must have .ltfy extension";
